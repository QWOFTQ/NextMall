...
export default function PaymentScreen() {
  ...
  const payments = ['Paypal', 'Stripe', 'CashOnDeliver', 'KakaoPay', 'NaverPay']
  ...
  return (
    <Layout title='Payment method'>
      ...
      <form className='mx-auto max-w-screen-md ' onSubmit={submitHandler}>
        <h1 className='mb-4 text-xl'>Payment Method - 지불방법 선택</h1>
        {
          payments.map((payment) => (
            <div key={payment} className='mb-4'>
              <input type='radio' name='paymentMethod' className='p-2 ouline-none focus:ring-0' id={payment} 
